...
A class library to turn off system animations during testing when using Espresso.
...
```groovy
compile 'com.github.shareme:GWSDroidInsUtil:{latest-release-number}@aar'
```



In your androidTest of your application under instrumented testing,
put an AndroidManifest.xml that you have stripped the application tag from and
...
```
In your non-flavor app build script put:
...
If you use flavours, well I am sure you figure out what needs to change to use that snippet.


And in your Application Test class:
